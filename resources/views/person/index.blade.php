        ...
        <div class="min-w-screen bg-gray-100 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
            <div class="w-full lg:w-2/3">
                ...
                <div class="bg-white shadow-md rounded my-2">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">{{ $person->gender }}</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                    ...
                    <div class="items-center justify-center border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                        {!! $people->links() !!}
                    </div>
                </div>
            </div>
